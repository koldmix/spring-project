...
class ClientControllerTest {
    ...
    void createClient_ValidRequest_shouldReturnCreated() throws Exception {
        // Arrange
        ClientCreateRequest createRequest = new ClientCreateRequest(88888L,
                "Иванов");
        ...
        mockMvc.perform(post("/api/v1/clients")
                        ...
                        .content("{\"mdmCode\": 88888, \"fullName\": \"Иванов\"}"))
                // Assert
                .andExpect(status().isCreated());
    }

    @Test
    void createClient_NotValidRequest_shouldReturnBadRequest() throws Exception {
        mockMvc.perform(post("/api/v1/clients")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{}"))
                // Assert
    ...
    @Test
    void deleteClient_ValidId_shouldReturnNoContent() throws Exception {
    ...
    @Test
    void deleteClient_NotValidId_shouldReturnNotFound() throws Exception {
        // Arrange
    ...
    @Test
    void deleteClient_ExistsBill_shouldReturnConflict() throws Exception {
        // Arrange
    ...
    @Test
    void getClient_ValidRequest_shouldReturnOK() throws Exception {
        // Arrange
    ...
    @Test
    void getClient_NotExistsId_shouldReturnNotFound() throws Exception {
        // Arrange
    ...
    @Test
    void searchClients_ValidRequest_shouldReturnOK() throws Exception {
        // Arrange
    ...
    @Test
    void updateClient_ValidRequest_shouldReturnOK() throws Exception {
        // Arrange
    ...
    @Test
    void updateClient_NotValidRequest_shouldReturnBadRequest() throws Exception {
        // Arrange
        ClientUpdateRequest clientUpdateRequest = new ClientUpdateRequest();
        clientUpdateRequest.setFullName("Новое имя");
        ClientResponse clientResponse = new ClientResponse();
    ...
    @Test
    void updateClient_NotExistsId_shouldReturnNotFound() throws Exception {
        // Arrange
        when(clientService.updateClient(eq(clientId), any(ClientUpdateRequest.class)))
    ...
    @Test
    void checkClientExists_ValidRequest_shouldReturnOK() throws Exception {
        // Arrange
        ...
        // Act
        mockMvc.perform(get("/api/v1/clients/{clientId}/exists", clientId))
                // Assert
                .andExpect(status().isOk())
